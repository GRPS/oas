...
<html>
    ...
    <body>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-5 mt">                        
                            <a href="#menu" title="Open menu."><img id="logo" class="img-responsive" src="<?=$this->config->item("domainLIVE").'assets/img/logo_b.png';?>" alt="Offord &amp; Sons Logo"></a>
                        </div>
        ...
        <div class="footer">
            <div class="container">
                <div class="col-xs-12">
                    <p>&copy; Offord &amp; sons 2014. All Rights Reserved.</p>
                </div>                
            </div>
        </div> <!-- footer -->
