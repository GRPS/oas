...
<div class="panel panel-default">
    <div class="panel-body text-right">
        <p>
            ...
            <span class="subprice product-price" data-value="<?=($total)?>"><?= fp($total) ?></span>
        </p>
        <p>
            ...
            <select class="selectpicker calcshipto show-tick snb mr" data-width="130px" name="shipto">
                ...
                <option value="18">Outside UK</option>
            </select>
            <span class="shipto product-price" data-value="8">&pound;8</span></p>
        <p>
            <strong class="mr">Order Total: </strong>
            <span class="totalprice product-price" data-value="<?=($total+8)?>"><?= fp($total+8) ?></span>
        </p>
    </div>
</div>
...
<form class="pull-right" id="frm_paypal_checkout" target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
    ...
    <input class="shipto" type="hidden" name="handling_cart" id="handlingcart" value="8">
