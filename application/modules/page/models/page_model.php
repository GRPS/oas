...
//            PrintExt($row); exit();
        ...
        $metaKeywords = $metaKeywordsExtra; //"offord and sons, jewellery, romsey, winchester, hampshire, wedding, eternity, engagement, ".$metaKeywordsExtra;
