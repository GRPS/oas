    ...
    <div class="row" style="padding: 10px 0px;">
        <div class="col-xs-12">
            ...
            <h5 class="hidden-xs" style="position:absolute; right:0px; top:15px;">
                <span class="home_show"><i class="fa fa-phone" aria-hidden="true"></i> 01962 867772</span>
                <span style="margin-left:30px;"><i class="fa fa-envelope" aria-hidden="true"></i> shop@offordandsons.co.uk</span>
