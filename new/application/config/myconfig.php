<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    $config['company_footer_year']  = '2021';
    $config['copyright']            = 'Copyright &copy; 2021 Offord & Sons All rights reserved.';
    $config['designed']             = 'Designed and created by Graham Simmons 2021.';
